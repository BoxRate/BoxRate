...
<body id="body-minuman">
   <header id="header">
	...
	<div id="content">
    <form  id="form" method="post" action="server-minuman.php" enctype="multipart/form-data">
      ...
      <div>
        ...
        <input id="input-name" type="text" name="text" placeholder="Nama Minuman"><br>
   ...
   <?php
         ...
         echo "<form method='post' action='server-minuman.php'>";
         ...
         while ($row=mysqli_fetch_array($result)) {
          ...
          echo "<input id ='check-all' type='checkbox' onclick='selectAll(this.checked)' value='Select All'/>";
         echo "</form>";
    ?>
