...
<html lang="en">
  ...
  <body >
	...
	<ul class="dropdown-menu">
        <li><a href="kecilbesarminuman.php">Rendah ke Tinggi</a></li>
        <li><a href="besarkecilminuman.php">Tinggi ke Rendah</a></li>
    </ul>
    </div>
	</div>
    <div class="col-sm-4" style="background-color:#DCDCDC;">
   ...
   <div class="dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <?php
           ...
           $sql= "SELECT * FROM menu WHERE ket='minuman' order by price DESC";
